				...
				<ul class="cl">
					<li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							...
							<li><a href="javascript:;" onclick="picture_add('添加图片','/admin/picture-add')"><i class="Hui-iconfont">&#xe613;</i> 图片</a></li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="/admin/article-list" data-title="资讯管理" href="javascript:void(0)">资讯管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-recruit">
			...
			<dd>
				<ul>
					<li><a _href="/admin/job-list" data-title="招聘管理" href="javascript:void(0)">招聘管理</a></li>
					<li><a _href="/admin/cv-list" data-title="简历管理" href="javascript:void(0)">简历管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a _href="/admin/picture-list" data-title="图片管理" href="javascript:void(0)">图片管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a _href="/admin/admin-role" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
					<li><a _href="/admin/admin-permission" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
					<li><a _href="/admin/admin-list" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<!--
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					<li><a _href="/admin/system-base" data-title="系统设置" href="javascript:void(0)">系统设置</a></li>
					<li><a _href="/admin/system-category" data-title="栏目管理" href="javascript:void(0)">栏目管理</a></li>
					<li><a _href="/admin/system-data" data-title="数据字典" href="javascript:void(0)">数据字典</a></li>
					<li><a _href="/admin/system-shielding" data-title="屏蔽词" href="javascript:void(0)">屏蔽词</a></li>
					<li><a _href="/admin/system-log" data-title="系统日志" href="javascript:void(0)">系统日志</a></li>
				</ul>
			</dd>
		</dl>
	</div>
