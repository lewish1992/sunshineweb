...
<div class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg">
		<thead>
			...
			<c:if test="${empty usertypesEntityList}">
				<div class="alert alert-warning" role="alert">
					<span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>Usertypes表为空，请添加</a>
				</div>
			</c:if>
		...
		<tbody>
		<c:forEach items="${usertypesEntityList}" var="usertypes">
		<tr class="text-c">
			<td><input type="checkbox" value="" name=""></td>
			<td>${usertypes.usertypeid}</td>
			<td>${usertypes.usertypename}</td>
			<td>
				<c:forEach items="${usertypes.usersesByUsertypeid}" var="users">
					${users.username},
				</c:forEach>
			</td>
